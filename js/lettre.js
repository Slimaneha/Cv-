         ...
         document.getElementById("choix4").innerHTML=manutention
                         ...
                         var selectElmt = document.getElementById("formTaxiUn");


                         var choixUn =""
                         function dommaine () {
                            choix = textselectionne = selectElmtTaxiUn.options[selectElmtTaxiUn.selectedIndex].text;
                            ...
                            if (choix === télévente)
                            {
                                document.getElementById("lettreStart").style.display="none"
                                document.getElementById("lettre").style.display="block"
                                document.getElementById("explication").innerHTML=post1;



                                document.getElementById("nom").innerHTML=messagesName ;
                                document.getElementById("entreprise").innerHTML = employeur; 
                            }
                           ...
                           else if (choix === Web)
                            {
                                document.getElementById("lettreStart").style.display="none"
                                document.getElementById("lettre").style.display="block"
                                document.getElementById("explication").innerHTML=post2;
                            ...
                            if (choix === manutention)
                            {
                                document.getElementById("lettreStart").style.display="none"
                                document.getElementById("lettre").style.display="block"
                                document.getElementById("explication").innerHTML=post3;
